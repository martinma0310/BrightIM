...
namespace AutoUpdate
{
	...
	public class FrmUpdate : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.linkLabel1.Text = "http://www.Bright.com";
		...
		{ 
			...
			{
                MessageBox.Show("更新配置下载失败，请检查网络连接！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
                return;
			}
            ...
            {
                MessageBox.Show("获取更新列表失败，请检查！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
                return;
            }
//			else
//				btnNext.Enabled = false;
		...
		private void DownUpdateFile()
		{
			...
			for(int i = 0;i < this.lvUpdateList.Items.Count;i++)
			{
				...
				{
					MessageBox.Show("更新文件下载失败！"+ ex.Message ,"错误",MessageBoxButtons.OK,MessageBoxIcon.Error);
				}
			}
			InvalidateControl();
